...
if(!isset($_SESSION["spotify"])){
  $session = new SpotifyWebAPI\Session(
      '6461734de0794769b094a13cca6e674d',
      'c25565f3dc4b4fb39b1417f087bcf25c',
      'http://localhost/blitzkrieg'
  );
  ...
  $_SESSION["spotify"] = $session->getAccessToken();
  $_SESSION["set-time"] = time();
}
else{
  $api = new SpotifyWebAPI\SpotifyWebAPI();
...
if(isset($_SESSION['set-time']) && time() - $_SESSION['set-time'] >= 3600){
